 ...
 */
public class Day06 {
    public static final String TEST_INPUT = "mjqjpqmgbljsphdztnvjfqwrcgsmlb";
    ...
    public static void main(String[] args) {
        String datastream = INPUT;
        //Part 1
        int position = getPosition(datastream, 4);
        System.out.println(position);
        //Part 2
        position = getPosition(datastream, 14);
        System.out.println(position);
    }

    private static int getPosition(String datastream, int numberOfChars) {
        int position = numberOfChars;
        do {
            long count = datastream.substring(position - numberOfChars,position)
